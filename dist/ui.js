...
window.onmessage = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (event.data.pluginMessage.type === 'HILIGHTFIRST') {
        var r = document.getElementById('resultsList').children;
        if (r.length != 0)
            r[0].setAttribute("class", "resultItemHilight");
    }
});
